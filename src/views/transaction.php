                                        ...
                                        <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                                            ...
                                            <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                                                <div class="flex items-center space-x-5">
                                                    <img
                                                        class="max-w-[44px] border border-gray6"
                            ...
                            <div class="px-8 py-8">
                                ...
                                <div class="">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <p class="mb-0 text-tiny ml-3">1. <a
                                                href="#"
                                                class="text-hover-primary"
                                            >Whitetails Women's Open Sky</a> <span class="font-medium">(x2)</span></p>
                                        <p class="mb-0 text-tiny ml-3">2. <a
                                                href="#"
                                                class="text-hover-primary"
                                            >Simple Modern School Boys</a><span class="font-medium">(x5)</span></p>
                                    </div>
                                    <div class="mb-6">
                                ...
                                <button
                                    class="text-black border border-gray6 px-5 py-2 hover:text-white hover:bg-info hover:border-info"
                                >
                                    <span class="mr-1">
                                        <svg
                                            class="-translate-y-px"
