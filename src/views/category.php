                    ...
                    <div class="col-span-12 lg:col-span-4">
                        <div class="mb-6 bg-white px-8 py-8 rounded-md">
                            <div class="mb-6">
                                ...
                                <span class="text-tiny text-center w-full inline-block mb-3">Image size must be less
                                    than 5Mb</span>
                                <div class="">
                                    <form action="#">
                                        <input
                            ...
                            <div class="mb-6">
                                ...
                                <textarea
                                    class="input h-[150px] w-full py-3 resize-none"
                                    placeholder="Description Here"
                                ></textarea>
                            </div>

                            <div class="admin-checkbox flex items-center mb-5">
                                <input
                                    id="product-1"
                                    type="checkbox"
                                >
                                <label
                                    for="product-1"
                                    class="text-tiny"
                                >Create As Parent Category</label>
                            </div>

                            <button class="admin-main-btn px-7 py-2">Add Category</button>
                        </div>
                    </div>
                                    ...
                                    <table class="w-full text-base text-left text-gray-500 ">
                                        ...
                                        <thead>
                                            <tr class="border-b border-gray6 text-tiny">
                                                ...
                                                <th
                                                    scope="col"
                                                    class="px-3 py-3 text-tiny text-text2 uppercase font-semibold w-[170px]"
                                                >
                                                    Name
                                                </th>
                                                <th
                                            ...
                                            <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                                                ...
                                                <td class="pr-8 py-5 whitespace-nowrap">
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                        <span
                                                            class="font-medium text-heading text-hover-primary transition"
                                                        >Fashion</span>
                                                    </a>
                                                </td>
                                            ...
                                            <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                                                ...
                                                <td class="pr-8 py-5 whitespace-nowrap">
                                                    ...
                                                    >
                                                        <img
                                                            class="w-10 h-10 rounded-full"
                                                            src="https://weblearnbd.net/tphtml/ebazer/../assets/img/product/prodcut-12.jpg"
                                                            alt=""
                                                        >
                                                        <span
                                                            class="font-medium text-heading text-hover-primary transition"
