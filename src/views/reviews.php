            ...
            <div class="body-content px-8 py-8 bg-slate-100">
                ...
                <div class="bg-white rounded-t-md rounded-b-md shadow-xs py-4">
                    <div class="admin-search-box flex items-center justify-between px-8 py-8 flex-wrap">
                        <div class="search-input relative mb-5 md:mb-0 mr-3">
                            <input
                        ...
                        <div class="flex sm:justify-end sm:space-x-6 flex-wrap">
                            <div class="search-select mr-3 flex items-center space-x-3 ">
                                <span class="text-tiny inline-block leading-none -translate-y-[2px]">Rating : </span>
                                <select>
                    ...
                    <div class="relative overflow-x-auto  mx-8">
                        <table class="w-[1400px] 2xl:w-full text-base text-left text-gray-500">
                                    ...
                                    <td class="pr-8 py-5 whitespace-nowrap">
                                        ...
                                        >
                                            <img
                                                ...
                                                alt=""
                                            >
                                            <span class="font-medium text-heading text-hover-primary transition">School
                                                Bag for kids</span>
                                        </a>
                                    </td>
                                    <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                                    ...
                                    <td class="pr-8 py-5 whitespace-nowrap">
                                        ...
                                        >
                                            <img
                                                ...
                                                alt=""
                                            >
                                            <span class="font-medium text-heading text-hover-primary transition">Minimal
                                                Shoes for women</span>
                                        </a>
                                    </td>
                                    <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                                        Stella Thomas
                    ...
                    <div class="flex justify-between items-center flex-wrap mx-8">
                        <p class="mb-0 text-tiny mr-3">Showing 10 Prdouct of 120</p>
                        <div class="pagination py-3 flex justify-end items-center mr-8">
                            <a
                                href="#"
