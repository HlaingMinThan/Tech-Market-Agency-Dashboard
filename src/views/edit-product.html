...
<head>
    ...
    <link
        rel="stylesheet"
        href="../assets/css/perfect-scrollbar.css"
    >
    <link
        rel="stylesheet"
    ...
    <link
        rel="stylesheet"
        href="../assets/css/apexcharts.css"
    >
    <link
        rel="stylesheet"
...
<body>
    ...
    <!--  -->
    <div
        class="admin-main-wrapper bg-slate-100 h-screen"
    ...
    >
        ...
        >
            ...
            <header class="relative z-10 bg-white border-b border-gray border-solid py-5 px-8 pr-8">
                <div class="flex justify-between">
                    ...
                    <div class="flex items-center justify-end space-x-6">
                        ...
                        <div
                            class="relative"
                            x-data="{ notificationTable: false }"
                        >
                            <button
                        ...
                        >
                            ...
                            >
                                <img
                                    class="w-[40px] h-[40px] rounded-md"
                                    src="https://weblearnbd.net/tphtml/ebazer/../assets/img/users/user-10.jpg"
                                    alt=""
                                >
                                <span
            ...
            <div class="body-content px-8 py-8 bg-slate-100">
                    ...
                    <div class="col-span-12 2xl:col-span-10">
                        <div class="flex justify-between mb-10 items-end flex-wrap">
                            ...
                            <div class="mb-2 flex sm:justify-end items-center flex-wrap">
                                <button class="admin-main-btn px-10 py-2 mr-2 sm:mb-0 mb-2">Publish</button>
                                <button
                                    class="admin-main-btn px-10 py-2 border border-[#dfdfdf] bg-transparent text-black hover:text-black hover:bg-white hover:border-white sm:mb-0 mb-2"
                                >Save Draft</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-12">
                    <div
                        class="col-span-12 2xl:col-span-10"
                        x-data="{ addProductTab: 1 }"
                    >
                        ...
                        <div class="">
                            ...
                            >
                                <div class="grid grid-cols-12 gap-6 mb-6">
                                    <div class="col-span-12 xl:col-span-8 2xl:col-span-9 ">
                                        <div class="mb-6 bg-white px-8 py-8 rounded-md">
                                            ...
                                            <!-- input -->
                                            <div class="mb-5">
                                                <p class="mb-0 text-base text-black">Product Name <span
                                        ...
                                        <div class="bg-white px-8 py-8 rounded-md mb-6">
                                            ...
                                            <!-- tax vat -->
                                            <div
                                                class="grid sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-x-6">

                                                <div class="mb-5">
                                                    <p class="mb-0 text-base text-black">Base Price <span
                                                            class="text-red"
                                                        >*</span></p>
                                                    <input
                                                        class="input w-full h-[44px] rounded-md border border-gray6 px-6 text-base"
                                                    ...
                                                    >
                                                    <span class="text-tiny leading-4">Set the base price of
                                                        product.</span>
                                                </div>
                                                <!-- input -->
                                                <div class="mb-5">
                                                    <p class="mb-0 text-base text-black">SKU <span
                                                            class="text-red">*</span></p>
                                                    <input
                                                        class="input w-full h-[44px] rounded-md border border-gray6 px-6 text-base"
                                                        type="text"
                                                ...
                                                <!-- input -->
                                                <div class="mb-5">
                                                    <p class="mb-0 text-base text-black">Qantity <span
                                                            class="text-red">*</span></p>
                                                    <input
                                                        class="input w-full h-[44px] rounded-md border border-gray6 px-6 text-base"
                                                        type="text"
                                            ...
                                            <div
                                                ...
                                                x-data="{ priceData: 3 }"
                                            >
                                                <p class="mb-0 text-base text-black">Discount Type <span
                                                        class="text-red"
                                                    >*</span></p>
                                                <div class="flex items-center sm:space-x-3 flex-wrap mb-5">
                                                    <div class="admin-checkbox-secondary mb-4">
                                                        <label
                                                            for="noDiscount"
                                                        ...
                                                        >
                                                            <small class="flex items-center">
                                                                <input
                                                                    ...
                                                                    name="priceDiscount"
                                                                >
                                                                <span class="text-base font-medium">Fixed
                                                                    Discount</span>
                                                            </small>
                                                        </label>
                                                    </div>
                                                        ...
                                                        >
                                                            <small class="flex items-center">
                                                                <input
                                                                    ...
                                                                    name="priceDiscount"
                                                                >
                                                                <span class="text-base font-medium">Percent
                                                                    Discount</span>
                                                            </small>
                                                        </label>
                                                    </div>
                                                ...
                                                <div
                                                    ...
                                                    x-show="priceData === 1"
                                                >
                                                    <p class="mb-0 text-base text-black">Price <span
                                                            class="text-red">*</span></p>
                                                    <input
                                                        class="input w-full h-[44px] rounded-md border border-gray6 px-6 text-base"
                                                        type="text"
                                                ...
                                                <div
                                                    ...
                                                    x-show="priceData === 2"
                                                >
                                                    <p class="mb-2 text-base text-black">Percent <span
                                                            class="text-red">*</span></p>
                                                    <input
                                                        type="text"
                                                        id="example_id"
                                                ...
                                                <div class="mt-10 hidden">
                                                    <div class="w-full">
                                                        ...
                                                        >
                                                            <div
                                                                class="slider-touch-left w-5 h-5 rounded-md absolute z-10 hover:cursor-pointer">
                                                                <span
                                                                    class="block w-full h-full bg-white rounded-full shadow-sm"
                                                                ></span>
                                                            </div>
                                                            <div
                                                                class="slider-touch-right w-5 h-5 rounded-md absolute z-10 hover:cursor-pointer">
                                                                <span
                                                                    class="block w-full h-full bg-white rounded-full shadow-sm"
                                                                ></span>
                                                            </div>
                                                            <div
                                                                class="slider-line absolute w-[calc(100%-5rem)] h-1 left-[18px] top-[7px] rounded bg-[#f9f9f9] overflow-hidden">
                                    ...
                                    <div class="col-span-12 xl:col-span-4 2xl:col-span-3 ">
                                        <div class="bg-white px-8 py-8 rounded-md mb-6">
                                            ...
                                            <span class="text-tiny text-center w-full inline-block mb-3">Image size must
                                                be less than 5Mb</span>
                                            <div class="">
                                                <form action="#">
                                                    <input
                                                        type="file"
                                ...
                                <div class="">
                                    <button class="admin-main-btn px-10 py-2 mb-2">Publish</button>
                                    <button
                                        class="admin-main-btn px-10 py-2 border border-[#dfdfdf] bg-transparent text-black hover:text-black hover:bg-white hover:border-white mb-2"
                                    >Save Draft</button>
                                </div>
                            </div>
                            <!-- general tab content -->
