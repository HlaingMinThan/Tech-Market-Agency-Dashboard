                        ...
                        <table class="w-full text-base text-left text-gray-500">
                            ...
                            <tbody>
                                <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                                    ...
                                    <td class="pr-8 py-5 whitespace-nowrap">
                                        ...
                                        >
                                            ...
                                            >
                                            <span
                                                class="font-medium text-heading text-hover-primary transition">Whitetails
                                                Women's Open Sky</span>
                                        </a>
                                    </td>
                                    ...
                                    <td class="pr-8 py-5 whitespace-nowrap">
                                        ...
                                        >
                                            <img
                                                ...
                                                alt=""
                                            >
                                            <span class="font-medium text-heading text-hover-primary transition">Simple
                                                Modern School Boys</span>
                                        </a>
                                    </td>
                                    <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                                        #DF7B2B64
                                ...
                                <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                                    ...
                                    <td class="pr-8 py-5 whitespace-nowrap">
                                        ...
                                        >
                                            <img
                                                ...
                                                alt=""
                                            >
                                            <span class="font-medium text-heading text-hover-primary transition">Women's
                                                Essentials Convertible</span>
                                        </a>
                                    </td>
                                    <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                                        #373F9567
                                    ...
                                    <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                                        <span
                                            class="text-[11px] -translate-y-[1px] inline-block  text-warning px-3 py-1 rounded-md leading-none bg-warning/10 font-medium text-end"
                                        >Low Stock</span> 05
                                    </td>
                                    <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                                        $56.99
                                ...
                                <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                                    ...
                                    <td class="pr-8 py-5 whitespace-nowrap">
                                        ...
                                        >
                                            <img
                                                ...
                                                alt=""
                                            >
                                            <span class="font-medium text-heading text-hover-primary transition">Calvin
                                                Klein Gabrianna Novelty</span>
                                        </a>
                                    </td>
                                    <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                                        #C174E363
                                    ...
                                    <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                                        <span
                                            class="text-[11px] -translate-y-[1px] inline-block  text-danger px-3 py-1 rounded-md leading-none bg-danger/10 font-medium text-end"
                                        >Out Stock</span> 00
                                    </td>
                                    <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                                        $340.18
                                    ...
                                    <td class="pr-8 py-5 whitespace-nowrap">
                                        ...
                                        >
                                            <img
                                                ...
                                                alt=""
                                            >
                                            <span class="font-medium text-heading text-hover-primary transition">Tommy
                                                Hilfiger Women’s Jaden</span>
                                        </a>
                                    </td>
                                    <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                                        #26BC663E
                                    ...
                                    <td class="pr-8 py-5 whitespace-nowrap">
                                        ...
                                        >
                                            <img
                                                ...
                                                alt=""
                                            >
                                            <span class="font-medium text-heading text-hover-primary transition">Govicta
                                                Men's Shoes Leather</span>
                                        </a>
                                    </td>
                                    <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                                        #AD6ACDB9
                                ...
                                <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                                    ...
                                    <td class="pr-8 py-5 whitespace-nowrap">
                                        ...
                                        >
                                            ...
                                            >
                                            <span
                                                class="font-medium text-heading text-hover-primary transition">Legendary
                                                Whitetails Men's.</span>
                                        </a>
                                    </td>
                                    <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                                        #3F6CBB65
                                ...
                                <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                                    ...
                                    <td class="pr-8 py-5 whitespace-nowrap">
                                        ...
                                        >
                                            ...
                                            >
                                            <span
                                                class="font-medium text-heading text-hover-primary transition">Backpack,
                                                School Bag.</span>
                                        </a>
                                    </td>
                                    <td class="px-3 py-3 font-normal text-[#55585B] text-end">
