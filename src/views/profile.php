                ...
                <div class="bg-white rounded-md overflow-hidden mb-10">
                    <div class="relative h-[200px] w-full">
                        <div
                            ...
                            class="data-bg absolute top-0 left-0 w-full h-full bg-no-repeat bg-cover"
                        ></div>
                        <!-- <input
                            type="file"
                            id="coverPhoto"
                    ...
                    <div class="px-8 pb-8 relative">
                        <div class="-mt-[75px] mb-3 relative inline-block">
                            <img
                                class="w-[150px] h-[150px] rounded-[14px] border-4 border-white bg-white"
                                ...
                                <div class="">
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                        <div class="mb-5">
                                            ...
                                            <input
                                                class="input w-full h-[49px] rounded-md border border-gray6 px-6 text-base text-black"
                                                type="text"
                                                placeholder="Name"
                                                value="Shahnewaz"
                                            >
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                        ...
                                        <div class="mb-5 profile-gender-select select-bordered">
                                            ...
                                            <select class="input w-full h-[49px] rounded-md border border-gray6 px-6 text-base text-black">
                                                <option
                                                    value=""
                                                    selected
                                                >Male</option>
                                    ...
                                    <div class="text-end mt-5">
                                        <button class="admin-main-btn px-10 py-2">Save</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 2xl:col-span-4">
                            <div class="py-10 px-10 bg-white rounded-md mb-6">
                                ...
                                <div class="space-y-3 flex flex-col">
                                    <div class="admin-checkbox flex items-center mb-3 sm:mb-0">
                                        <input
                                            id="follows"
                                            type="checkbox"
                                        >
