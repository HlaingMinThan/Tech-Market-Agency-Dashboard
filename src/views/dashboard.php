            ...
            <div class="body-content px-8 py-8 bg-slate-100">
                <div class="flex justify-between items-end flex-wrap">
                    <div class="page-title mb-7">
                        <h3 class="mb-0 text-3xl">Dashboard</h3>
                        <p class="text-textBody m-0">Welcome to your dashboard</p>
                    </div>
                    <div class=" mb-7">
                        <a
                            href="add-product.html"
                            class="admin-main-btn px-5 py-2"
                        >Add Product</a>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 mb-6">
                    <div class="widget-item bg-white p-6 flex justify-between rounded-md">
                        ...
                        <div>
                            <span
                                class="text-lg text-white rounded-full flex items-center justify-center h-12 w-12 shrink-0 bg-success"
                            >
                                <svg
                                    width="20"
                                    height="20"
                    ...
                    <div class="widget-item bg-white p-6 flex justify-between rounded-md">
                        ...
                        <div>
                            <span
                                class="text-lg text-white rounded-full flex items-center justify-center h-12 w-12 shrink-0 bg-purple"
                            >
                                <svg
                                    width="20"
                                    height="22"
                    ...
                    <div class="widget-item bg-white p-6 flex justify-between rounded-md">
                        ...
                        <div>
                            <span
                                class="text-lg text-white rounded-full flex items-center justify-center h-12 w-12 shrink-0 bg-info"
                            >
                                <svg
                                    width="22"
                                    height="22"
                    ...
                    <div class="widget-item bg-white p-6 flex justify-between rounded-md">
                        ...
                        <div>
                            <span
                                class="text-lg text-white rounded-full flex items-center justify-center h-12 w-12 shrink-0 bg-warning"
                            >
                                <svg
                                    width="23"
                                    height="22"
                    ...
                    <div class="bg-white p-8 col-span-12 xl:col-span-4 2xl:col-span-3 rounded-md">
                        <div class="flex items-center justify-between mb-8">
                            ...
                            <a
                                ...
                                class="leading-none text-base text-info border-b border-info border-dotted capitalize font-medium hover:text-info/60 hover:border-info/60"
                            >View All</a>
                        </div>
                        <div class="space-y-5">
                                    ...
                                    <tbody>
                                        <tr class="bg-white border-b border-gray6 last:border-0 text-start">
                                            <td class="pr-8  whitespace-nowrap">
                                                <a
                                                    href="#"
                                                    class="font-medium text-heading text-hover-primary"
                                                >Apple MacBook Pro 17"</a>
                                            </td>
                                            ...
                                            <td class="px-3 py-3">
                                                <span
                                                    class="text-[11px]  text-success px-3 py-1 rounded-md leading-none bg-success/10 font-medium"
                                                >Active</span>
                                            </td>
                                        ...
                                        <tr class="bg-white border-b border-gray6 last:border-0 text-start">
                                            ...
                                            <td class="px-3 py-3">
                                                <span
                                                    class="text-[11px]  text-danger px-3 py-1 rounded-md leading-none bg-danger/10 font-medium"
                                                >Disabled</span>
                                            </td>
                                            <td class="px-3 py-3 w-14">
                                                <button
                                        ...
                                        <tr class="bg-white border-b border-gray6 last:border-0 text-start">
                                            ...
                                            <td class="px-3 py-3">
                                                <span
                                                    class="text-[11px]  text-warning px-3 py-1 rounded-md leading-none bg-warning/10 font-medium"
                                                >Disabled</span>
                                            </td>
                                            <td class="px-3 py-3 w-14">
                                                <button
                    ...
                    <div class="bg-white p-8 col-span-12 xl:col-span-12 2xl:col-span-3 rounded-md">
                        ...
                        <div class="space-y-4">
                            <div class="bar">
                                ...
                                <div class="relative h-2 w-full bg-[#3b5998] rounded">
                                    <div
                                        data-width="20%"
                            ...
                            <div class="bar">
                                ...
                                <div class="relative h-2 w-full bg-[#FF0000] rounded">
                                    <div
                                        data-width="80%"
                                        class="data-width absolute top-0 h-full rounded bg-[#FF0000] progress-bar "
                                    ></div>
                                </div>
                            </div>
                            <div class="bar">
                                ...
                                <div class="relative h-2 w-full bg-[#25D366] rounded">
                                    <div
                                        data-width="65%"
                            ...
                            <div class="bar">
                                ...
                                <div class="relative h-2 w-full bg-[#C13584] rounded">
                                    <div
                                        data-width="65%"
                            ...
                            <div class="bar">
                                ...
                                <div class="relative h-2 w-full bg-[#737373] rounded">
                                    <div
                                        data-width="10%"
                                        ...
                                        <tr class="bg-white border-b border-gray6 last:border-0 text-start">
                                            ...
                                            <td class="px-3 py-3">
                                                <div class="flex items-center space-x-2">
                                                    <button
                                                        class="bg-success flex items-center hover:bg-green-600 text-white text-center leading-5 text-tiny font-medium pt-2 pb-[6px] px-4 rounded-md"
                                                    >
                                                        <span
                                                            class="text-[9px] inline-block -translate-y-[1px] mt-2 mr-1"
                                                        >
                                                            <svg
                                                                class="-translate-y-px"
                                                                height="10"
                                                    ...
                                                    <button
                                                        class="bg-white flex items-center text-slate-700 border border-slate-200 hover:bg-danger hover:border-danger hover:text-white text-center leading-5 text-tiny font-medium pt-[6px] pb-[5px] px-4  rounded-md "
                                                    >
                                                        <span
                                                            class="text-[9px] inline-block -translate-y-[1px] mr-1 mt-2"
                                                        ><svg
                                                                class="-translate-y-px"
                                                                width="12"
                                                                height="12"
