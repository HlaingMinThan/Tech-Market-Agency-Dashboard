        ...
        >
            ...
            <div class="body-content px-8 py-8 bg-slate-100">
                <div class="flex justify-between mb-10">
                    <div class="page-title">
                        ...
                        <ul class="text-tiny font-medium flex items-center space-x-3 text-text3">
                            ...
                            <li class="breadcrumb-item text-muted">Product Grid</li>
                ...
                <div class="bg-white rounded-t-md rounded-b-md shadow-xs py-4">
                    <div class="admin-search-box flex items-center justify-between px-8 py-8 flex-wrap">
                        ...
                        <div class="flex sm:justify-end sm:space-x-6 flex-wrap">
                            <div class="search-select mr-3 flex items-center space-x-3 ">
                                <span class="text-tiny inline-block leading-none -translate-y-[2px]">Categories :
                                </span>
                                <select>
                                    <option>Shoes</option>
                                    <option>Shirt</option>
                    ...
                    <div class="relative mx-8 mb-5">
                        <div
                            ...
                            <div class="rounded-md bg-white border-gray6 border">
                                <div class="relative">
                                    <a href="#">
                                        <img
                                            class="w-full"
                                    ...
                                    <div class="absolute top-5 right-5 z-10">
                                        <div class="flex flex-col items-center justify-center space-y-2">
                                            ...
                                            >
                                                ...
                                                <div
                                                    x-show="editTooltip"
                                                    class="flex items-center z-50 absolute right-full translate-y-1/2 bottom-1/2 mr-1 mb-[2px]"
                                                >
                                                    <span
                                ...
                                <div class="px-5 py-5">
                                    <a
                                        href="#"
                                        class="text-lg font-normal text-heading text-hover-primary mb-2 inline-block leading-none"
                                    ...
                                    <div class="leading-none mb-2">
                                        <span class="text-base font-medium text-black">$170.00</span>
                                    </div>
                                </div>
                            </div>
                            <div class="rounded-md bg-white border-gray6 border">
                                ...
                                <div class="px-5 py-5">
                                    ...
                                    <div class="leading-none mb-2">
                                        <span class="text-base font-medium text-black">$45.00</span>
                                    </div>
                                </div>
                            </div>
                            <div class="rounded-md bg-white border-gray6 border">
                                ...
                                <div class="px-5 py-5">
                                    ...
                                    <div class="leading-none mb-2">
                                        <span class="text-base font-medium text-black">$350.00</span>
                                    </div>
                                </div>
                            </div>
                            <div class="rounded-md bg-white border-gray6 border">
                                ...
                                <div class="px-5 py-5">
                                    ...
                                    <div class="leading-none mb-2">
                                        <span class="text-base font-medium text-black">$240.00</span>
                                    </div>
                                </div>
                            </div>
                            <div class="rounded-md bg-white border-gray6 border">
                                ...
                                <div class="px-5 py-5">
                                    ...
                                    <div class="leading-none mb-2">
                                        <span class="text-base font-medium text-black">$160.00</span>
                                    </div>
                                </div>
                            </div>
                            <div class="rounded-md bg-white border-gray6 border">
                                <div class="relative">
                                    <a href="#">
                                        <img
                                            class="w-full"
                                            src="https://weblearnbd.net/tphtml/ebazer/../assets/img/product/prodcut-6.jpg"
                                            alt=""
                                        >
                                    </a>
                                    <div class="absolute top-5 right-5 z-10">
                                ...
                                <div class="px-5 py-5">
                                    ...
                                    <div class="leading-none mb-2">
                                        <span class="text-base font-medium text-black">$75.00</span>
                                    </div>
                                </div>
                            </div>
                            <div class="rounded-md bg-white border-gray6 border">
                                <div class="relative">
                                    <a href="#">
                                        <img
                                            class="w-full"
                                            src="https://weblearnbd.net/tphtml/ebazer/../assets/img/product/prodcut-7.jpg"
                                            alt=""
                                        >
                                    </a>
                                    <div class="absolute top-5 right-5 z-10">
                                ...
                                <div class="px-5 py-5">
                                    ...
                                    <div class="leading-none mb-2">
                                        <span class="text-base font-medium text-black">$55.00</span>
                                    </div>
                                </div>
                            </div>
                            <div class="rounded-md bg-white border-gray6 border">
                                <div class="relative">
                                    <a href="#">
                                        <img
                                            class="w-full"
                                            src="https://weblearnbd.net/tphtml/ebazer/../assets/img/product/prodcut-8.jpg"
                                            alt=""
                                        >
                                    </a>
                                    <div class="absolute top-5 right-5 z-10">
                                ...
                                <div class="px-5 py-5">
                                    ...
                                    <div class="leading-none mb-2">
                                        <span class="text-base font-medium text-black">$40.00</span>
                                    </div>
                                </div>
                            </div>
                            <div class="rounded-md bg-white border-gray6 border">
                                <div class="relative">
                                    <a href="#">
                                        <img
                                            class="w-full"
                                            src="https://weblearnbd.net/tphtml/ebazer/../assets/img/product/prodcut-9.jpg"
                                            alt=""
                                        >
                                    </a>
                                    <div class="absolute top-5 right-5 z-10">
                                ...
                                <div class="px-5 py-5">
                                    ...
                                    <div class="leading-none mb-2">
                                        <span class="text-base font-medium text-black">$99.99</span>
                                    </div>
                                </div>
                            </div>
                            <div class="rounded-md bg-white border-gray6 border">
                                <div class="relative">
                                    <a href="#">
                                        <img
                                            class="w-full"
                                            src="https://weblearnbd.net/tphtml/ebazer/../assets/img/product/prodcut-10.jpg"
                                            alt=""
                                        >
                                    </a>
                                    <div class="absolute top-5 right-5 z-10">
                                ...
                                <div class="px-5 py-5">
                                    ...
                                    <div class="leading-none mb-2">
                                        <span class="text-base font-medium text-black">$29.50</span>
                                    </div>
                                </div>
                            </div>
                        </div>
